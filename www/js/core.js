...
var GC={android:navigator&&navigator.userAgent&&navigator.userAgent.match(/Android/)?1:0,apple:navigator&&navigator.userAgent&&navigator.userAgent.match(/Mac OS/)?1:0,supportTouch:"ontouchstart"in document.documentElement,supportLS:"undefined"!=typeof localStorage,Core:{_prefix:"http://c.airgames.com",_included:{},_pending:{},_executing:{},revision:function(){return isNaN(parseInt("20120913165023"))?(new Date).getTime():"20120913165023"},sdk:function(){return typeof SDK!="undefined"||parent.document!=document&&window.parent.AG!=
